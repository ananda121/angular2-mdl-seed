...
(function(global) {
	...
	var map = {
		...
		'angular2-mdl' : 'node_modules/angular2-mdl/dist/components',
		'app' : 'src/tmp/app',
		'test' : 'src/tmp/test'
	};
	...
	var npmPackages = ['@angular', 'rxjs', 'lodash'];
	...
	var ngPackageNames = ['common', 'compiler', 'core', 'forms', 'http', 'platform-browser', 'platform-browser-dynamic', 'router'];
